      ...
      <div className="relative overflow-hidden noise-bg">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-gray-400 max-w-xl mx-auto mb-8">
            We come to your home, office, or anywhere in the Scottsdale area.
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Premium mobile car detailing serving the greater Scottsdale and
              Phoenix metropolitan area. We bring the detail shop to you.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-gray-400">
              <div>
                ...
                <a href="tel:+14805550199" className="hover:text-gold transition-colors">
                  (480) 555-0199
                </a>
              </div>
              <div>
                ...
                <a
                  href="mailto:info@superiormobiledetailing.com"
                  className="hover:text-gold transition-colors"
                >
                  info@superiormobiledetailing.com
                </a>
              </div>
              <div>
        ...
        <div className="border-t border-slate mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-600">
            &copy; {new Date().getFullYear()} Superior Mobile Detailing. All
            rights reserved.
          </p>
